 ...
 * When updates (method {@link #add}) are contended across threads, the
 * set of variables may grow dynamically to reduce contention. Method
 * {@link #sum} (or, equivalently, {@link #longValue}) returns the
 * current total combined across the variables maintaining the sum.
 * <p>
 * This class is usually preferable to {@link AtomicLong} when multiple
 ...
 * <p>
 * This class extends {@link Number}, but does <em>not</em> define methods
