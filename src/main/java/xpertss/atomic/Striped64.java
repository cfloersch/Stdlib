...
abstract class Striped64 extends Number {
   ...
   static final class Cell {
      ...
      static final AtomicLongFieldUpdater<Cell> updater =
      ...
      {
         return updater.compareAndSet(this, cmp, val);
      }
   ...
   static final AtomicLongFieldUpdater<Striped64> baseUpdater =
         AtomicLongFieldUpdater.newUpdater(Striped64.class, "base");

   static final AtomicIntegerFieldUpdater<Striped64> busyUpdater =
