...
public enum StateProvince {
   ...
   AS("America Samoa", 2),      AZ("Arizona", 4 | 8),              CA("California", 4 | 8),
   CO("Colorado", 4 | 8),       CT("Connecticut", 4 | 8),          DC("District of Columbia", 2 | 8),
   DE("Delaware", 4 | 8),       FL("Florida", 4 | 8),              GA("Georgia", 4 | 8),
   GU("Guam", 2),               HI("Hawaii", 4),                   IA("Iowa", 4 | 8),
   ID("Idaho", 4 | 8),          IL("Illinois", 4 | 8),             IN("Indiana", 4 | 8),
   KS("Kansas", 4 | 8),         KY("Kentucky", 4 | 8),             LA("Louisiana", 4 | 8),
   MA("Massachusetts", 4 | 8),  MD("Maryland", 4 | 8),             ME("Maine", 4 | 8),
   MI("Michigan", 4 | 8),       MN("Minnesota", 4 | 8),            MO("Missouri", 4 | 8),
   MS("Mississippi", 4 | 8),    MT("Montana", 4 | 8),              NC("North Carolina", 4 | 8),
   ND("North Dakota", 4 | 8),   NE("Nebraska", 4 | 8),             NV("Nevada", 4 | 8),
   NH("New Hampshire", 4 | 8),  NJ("New Jersey", 4 | 8),           NM("New Mexico", 4 | 8),
   NY("New York", 4 | 8),       OH("Ohio", 4 | 8),                 OK("Oklahoma", 4 | 8),
   OR("Oregon", 4 | 8),         PA("Pennsylvania", 4 | 8),         PR("Puerto Rico", 2),
   RI("Rhode Island", 4 | 8),   SC("South Carolina", 4 | 8),       SD("South Dakota", 4 | 8),
   TN("Tennessee", 4 | 8),      TX("Texas", 4 | 8),                UT("Utah", 4 | 8),
   VA("Virginia", 4 | 8),       VI("Virgin Islands", 2),           VT("Vermont", 4 | 8),
