 ...
 * <ul>
 * <li><strong>Simple (<code>name</code>)</strong> - The specified <code>name</code>
 * identifies an individual property of a particular JavaBean.  The name of the actual
 * getter or setter method to be used is determined using standard JavaBeans instrospection,
 * so that (unless overridden by a <code>BeanInfo</code> class, a property named "xyz"
 * will have a getter method named <code>getXyz()</code> or (for boolean properties only)
 * <code>isXyz()</code>, and a setter method named <code>setXyz()</code>.</li>
 *
 * <li><strong>Nested (<code>name1.name2.name3</code>)</strong> The first name element is
 * used to select a property getter, as for simple references above.  The object returned
 * for this property is then consulted, using the same approach, for a property getter for
 * a property named <code>name2</code>, and so on.  The property value that is ultimately
 * retrieved or modified is the one identified by the last name element.</li>
 *
 * <li><strong>Indexed (<code>name[index]</code>)</strong> - The underlying property value
 * is assumed to be an array, or this JavaBean is assumed to have indexed property getter
 * and setter methods.  The appropriate (zero-relative) entry in the array is selected.
 * <code>List</code> objects are now also supported for read/write.  You simply need to
 * define a getter that returns the <code>List</code></li>
 *
 * <li><strong>Mapped (<code>name(key)</code>)</strong> - The JavaBean is assumed to have
 * an property getter and setter methods with an additional attribute of type
 * <code>java.lang.String</code>.</li>
 *
 * <li><strong>Combined (<code>name1.name2[index].name3(key)</code>)</strong> - Combining
 * mapped, nested, and indexed references is also supported.</li>
 * </ul>
 */
public class PropertyUtils {
    ...
    */
   private static HashMap<Class,HashMap<String,PropertyDescriptor>> mappedDescriptorsCache = new HashMap<>();
    ...
    * cases where the property names are the same (even though the actual getter and
    * setter methods might have been customized via <code>BeanInfo</code> classes).
    ...
    * <strong>Note</strong> that this method is intended to perform a "shallow copy"
    * of the properties and so complex properties (for example, nested ones) will not
    * be copied.
    *
    ...
    * @throws IllegalArgumentException  if the <code>dest</code> or <code>orig</code>
    *                                   argument is null
   ...
   /**
    * Returns an Enumeration over the property names that exist in the specified bean.
    *
    * @param bean - Bean whose property names are to be Enumerated
    * @return An Enumeration over the String property names.
    */
   public static Enumeration<String> getPropertyNames(Object bean)
   {
   ...
   /**
    * Retrieve the property descriptor for the specified property of the specified bean, or
    * return <code>null</code> if there is no such descriptor.  This method resolves indexed
    * and nested property references in the same manner as other methods in this class, except
    * that if the last (or only) name element is indexed, the descriptor for the last resolved
      ...
      throws IllegalAccessException, InvocationTargetException, NoSuchMethodException
   {
      ...
      HashMap<String,PropertyDescriptor> mappedDescriptors = getMappedPropertyDescriptors(bean.getClass());
   ...
   /**
    * Return the Java Class representing the property editor class that has been registered
   ...
   /**
    * Return <code>true</code> if the specified property name identifies a readable
    * property on the specified bean; otherwise, return <code>false</code>.
    *
   ...
   /**
    * Return <code>true</code> if the specified property name identifies a writeable
    * property on the specified bean; otherwise, return <code>false</code>.
    *
    * @param bean Bean to be examined
    * @param name Property name to be evaluated
    * @throws NullPointerException if <code>bean</code> or <code>name</code> is
    *                              <code>null</code>
    */
   ...
   /**
    * Return the value of the specified property of the specified bean, no matter which
    * property reference format is used, with no type conversions.
    *
    ...
    * @throws IllegalAccessException    if the caller does not have access to the
    *                                   property accessor method
    * @throws IllegalArgumentException  if <code>bean</code> or <code>name</code>
    *                                   is null
    * @throws InvocationTargetException if the property accessor method throws an
    *                                   exception
   ...
   /**
    * Set the value of the specified property of the specified bean, no matter which
    * property reference format is used, with no type conversions.
    *
   ...
   // Methods to facilitate getting java bean properties


   /**
    * Return the value of the (possibly nested) property of the specified name, for the
    ...
    *                                   found
    */
   private static Object getNestedProperty(Object bean, String name)
      throws IllegalAccessException, InvocationTargetException, NoSuchMethodException
   {
      ...
      while(true) {
         ...
         if(indexOfMAPPED_DELIM2 >= 0 && indexOfMAPPED_DELIM >= 0 && (indexOfNESTED_DELIM < 0 || indexOfNESTED_DELIM > indexOfMAPPED_DELIM)) {
            indexOfNESTED_DELIM = name.indexOf(NESTED_DELIM, indexOfMAPPED_DELIM2);
         } else {
            indexOfNESTED_DELIM = name.indexOf(NESTED_DELIM);
         }
    ...
    * brackets) as a suffix to the property name, or <code>IllegalArgumentException</code>
    * will be thrown.  In addition to supporting the JavaBeans specification, this method has
    * been extended to support <code>List</code> objects as well.
    *
    * @param bean Bean whose property is to be extracted
    * @param name <code>property name[index]</code> of the property value to be extracted
    * @throws ArrayIndexOutOfBoundsException if the specified index is outside the valid range
   ...
   /**
    * Return the value of the specified indexed property of the specified bean, with no type
    * conversions.  In addition to supporting the JavaBeans specification, this method has
    * been extended to support <code>List</code> objects as well.
    *
    * @param bean  Bean whose property is to be extracted
    ...
    *                                        found
    */
   private static Object getIndexedProperty(Object bean, String name, int index)
      throws IllegalAccessException, InvocationTargetException, NoSuchMethodException
   {
    ...
    * conversions.  The key of the required value must be included (in brackets) as a suffix
    * to the property name, or <code>IllegalArgumentException</code> will be  thrown.
    *
    * @param bean Bean whose property is to be extracted
    * @param name <code>property name(key)</code> of the property value to be extracted
    * @throws IllegalAccessException    if the caller does not have access to the property
    *                                   accessor method
    * @throws InvocationTargetException if the property accessor method throws an exception
    * @throws NoSuchMethodException     if an accessor method for this property cannot be
    ...
    *                                   found
    */
   private static Object getMappedProperty(Object bean, String name, String key)
      throws IllegalAccessException, InvocationTargetException, NoSuchMethodException
   {
      ...
      if(descriptor instanceof MappedPropertyDescriptor) {
         ...
         Method readMethod = descriptor.getReadMethod();
         if(readMethod != null) {
            Object invokeResult = readMethod.invoke(bean);
    ...
    */
   private static HashMap<String,PropertyDescriptor> getMappedPropertyDescriptors(Class beanClass)
   {
    ...
    *                                   access to the property accessor method
    * @throws IllegalArgumentException  if <code>bean</code> or <code>name</code> is null
    *                                   or if the property name is nested or indexed
    * @throws InvocationTargetException if the property accessor method throws an exception
    * @throws NoSuchMethodException     if an accessor method for this property cannot be
    *                                   found
    */
   private static Object getSimpleProperty(Object bean, String name)
      throws IllegalAccessException, InvocationTargetException, NoSuchMethodException
   {
   ...
   // Methods to facilitate setting java bean properties
    ...
    *                                   found
    */
   private static void setNestedProperty(Object bean, String name, Object value)
      throws IllegalAccessException, InvocationTargetException, NoSuchMethodException
   {
    ...
    * conversions.  The zero-relative index of the required value must be included (in
    * square brackets) as a suffix to the property name, or
    * <code>IllegalArgumentException</code> will be thrown.  In addition to supporting
    * the JavaBeans specification, this method has been extended to support
    * <code>List</code> objects as well.
    *
    * @param bean  Bean whose property is to be modified
    * @param name  <code>property name[index]</code> of the property value to be modified
    * @param value Value to which the specified property element should be set
    * @throws ArrayIndexOutOfBoundsException if the specified index is outside the valid
    *                                        range for the underlying array
    * @throws IllegalAccessException         if the caller does not have access to the
    *                                        property accessor method
    * @throws IllegalArgumentException       if <code>bean</code> or <code>name</code> is
    *                                        null
    ...
    *                                        be found
    */
   private static void setIndexedProperty(Object bean, String name, int index, Object value)
      throws IllegalAccessException, InvocationTargetException, NoSuchMethodException
   {
      ...
      Object array = readMethod.invoke(bean);
    ...
    * conversions.  The key of the value to set must be included (in brackets) as a suffix
    * to the property name, or <code>IllegalArgumentException</code> will be thrown.
    *
    * @param bean  Bean whose property is to be set
    * @param name  <code>property name(key)</code> of the property value to be set
    ...
    *                                   found
    */
   private static void setMappedProperty(Object bean, String name, String key, Object value)
      throws IllegalAccessException, InvocationTargetException, NoSuchMethodException
   {
   ...
   private static class ArrayEnumeration<T> implements Enumeration<T> {
      ...
      /**
       * Public constructor which builds an ArrayEnumeration object
       * with the specified Array.
       *
       * @param a - The array to enumerate through
       */
      ...
      /**
       * Public constructor which builds an ArrayEnumeration object
       * with the specified Array and array offset and length.
       *
       * @param a - The array to enumerate through
       * @param offset - The starting offset in the array to enumerate
       * @param len - The number of array elements to enumerate through
       */
      public ArrayEnumeration(T[] a, int offset, int len)
      {
         this.a = a;
         this.i = offset;
         this.len = len + offset;
      ...
      /**
       * This method will return the next element in the array
       *
       * @return Object - The next object in the array
      ...
      /**
       * This method will return true if there are more elements in the array
       * to enumerate, false otherwise.
       *
       * @return boolean - True if there are more elements to enumerate
       */
