...
public final class Primitives {
   ...
   {
      return WRAPPER_TO_PRIMITIVE_TYPE.containsKey(Objects.notNull(type));
   }
   ...
   public static <T> Class<T> wrap(Class<T> type)
   {
      ...
      Class<T> wrapped = (Class<T>) PRIMITIVE_TO_WRAPPER_TYPE.get(Objects.notNull(type));
   ...
   {
      @SuppressWarnings("unchecked")
      Class<T> unwrapped = (Class<T>) WRAPPER_TO_PRIMITIVE_TYPE.get(Objects.notNull(type));
