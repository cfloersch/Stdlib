...
public final class Integers {
    ...
    */
   public static boolean regionMatches(int[] src, int sOffset, int[] other, int oOffset, int len)
   {
    ...
    * @return {@code true} if the regions match, {@code false} otherwise
    */
   public static boolean startsWith(int[] src, int[] other, int oOffset, int len)
   {
    ...
    * @return {@code true} if the regions match, {@code false} otherwise
    */
   public static boolean startsWith(int[] src, int[] other)
   {
    ...
    * @return {@code true} if the regions match, {@code false} otherwise
    */
   public static boolean endsWith(int[] src, int[] other, int oOffset, int len)
   {
    ...
    * @return {@code true} if the regions match, {@code false} otherwise
    */
   public static boolean endsWith(int[] src, int[] other)
   {
