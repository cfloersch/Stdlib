...
public final class Shorts {
    ...
    */
   public static short parse(CharSequence str, short def)
   {
      try { return Short.parseShort(CharSequences.toString(str)); } catch (Exception e) { return def; }
   }
    ...
    */
   public static short parse(CharSequence str, int radix, short def)
   {
      try { return Short.parseShort(CharSequences.toString(str), radix); } catch (Exception e) { return def; }
   }
    ...
    */
   public static boolean regionMatches(short[] src, int sOffset, short[] other, int oOffset, int len)
   {
    ...
    * @return {@code true} if the regions match, {@code false} otherwise
    */
   public static boolean startsWith(short[] src, short[] other, int oOffset, int len)
   {
    ...
    * @return {@code true} if the regions match, {@code false} otherwise
    */
   public static boolean startsWith(short[] src, short[] other)
   {
    ...
    * @return {@code true} if the regions match, {@code false} otherwise
    */
   public static boolean endsWith(short[] src, short[] other, int oOffset, int len)
   {
    ...
    * @return {@code true} if the regions match, {@code false} otherwise
    */
   public static boolean endsWith(short[] src, short[] other)
   {
