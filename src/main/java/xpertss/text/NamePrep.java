...
/**
 * Implements the StringPrep profile defined in RFC3491.
 */
class NamePrep extends StringPrep {



   // Combined C.1.2, C.2.2, C.3, C.4, C.5, C.6, C.7, C.8, & C.9
   private static final int[][] prohibited = {
      {0x00000080, 0x000000A0},
