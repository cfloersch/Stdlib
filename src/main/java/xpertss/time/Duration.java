...
public class Duration {
   ...
   /**
    * Parse the given string duration into a value of the specified
    * unit. If the source duration includes unit information the
    * value will be converted to the specified time unit. Otherwise,
    * the value is assumed to be in the specified time unit.
    *
